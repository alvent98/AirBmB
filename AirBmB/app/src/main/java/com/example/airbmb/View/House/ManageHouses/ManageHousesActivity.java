...
//        {
//            @Override
//            public void onClick(View view) presenter.onStartAddNew();
//        });
//
...
//    public void loadSource(List<House> input  adapter.loadSource(input);
//
...
//
//    public void setPageName(String value) getSupportActionBar().setTitle(value);
//
