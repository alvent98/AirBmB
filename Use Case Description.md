...
## 4. **Αίτημα ενοικίασης**
  ...
  2. Το σύστημα εμφανίζει τις παλαιότερες αναζητήσεις του χρήστη, αν υπάρχουν.
  ...
  4. Ο ενοικιαστής, συμπληρώνει τα κριτήρια της αναζήτησης, βάση προκαθορισμένων επιλογών.
  5. Το σύστημα επεξεργάζεται κατάλληλα τα παραπάνω στοιχεία και εμφανίζει έπειτα από αναζήτηση στη βάση δεδομένων, τα συναφή με την αναζήτηση του ενοικιαστή διαμερίσματα.
...
## 6. __Διαχείρηση αιτημάτων ενοικίασης__

Όταν ένας πιθανός ενοικιαστής ενδιαφέρεται για το ακίνητο ενός ιδιοκτήτη τότε θα πρέπει να του στείλει ένα αίτημα ενοικίασης για την χρονική περίοδο για την οποία ενδιαφέρεται.Ύστερα ο ιδιοκτήτης καλείται να αποφασίσει εαν θα αποδεχθεί το αίτημα η όχι με την εξής διαδικασία :
